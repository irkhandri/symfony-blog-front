...
return [
    ...
    [ // $staticRoutes
        ...
        '/blogs/create' => [[['_route' => 'blog-create', '_controller' => 'App\\Controller\\BlogController::create'], null, ['POST' => 0, 'GET' => 1], null, false, false, null]],
        '/interest-create' => [[['_route' => 'interest-create', '_controller' => 'App\\Controller\\InterestController::index'], null, null, null, false, false, null]],
        '/outbox-messages' => [[['_route' => 'outbox-messages', '_controller' => 'App\\Controller\\MessageController::outbox'], null, null, null, false, false, null]],
    ...
    [ // $dynamicRoutes
        ...
        80 => [[['_route' => 'blog-edit', '_controller' => 'App\\Controller\\BlogController::edit'], ['id'], null, null, false, true, null]],
        102 => [[['_route' => 'blog-delete', '_controller' => 'App\\Controller\\BlogController::delete'], ['id'], ['GET' => 0, 'DELETE' => 1], null, false, true, null]],
        138 => [[['_route' => 'interest-edit', '_controller' => 'App\\Controller\\InterestController::edit'], ['id'], null, null, false, true, null]],
        161 => [[['_route' => 'interest-delete', '_controller' => 'App\\Controller\\InterestController::del'], ['id'], null, null, false, true, null]],
        ...
        270 => [
            [['_route' => 'edit-profile', '_controller' => 'App\\Controller\\ProfileController::edit'], ['id'], null, null, false, true, null],
